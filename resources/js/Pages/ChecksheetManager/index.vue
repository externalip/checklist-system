            ...
            <section id="checksheet-filter-section">
                ...
                <section id="checksheet-filters" class="mb-5 grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-3">
                    ...
                    <div id="checksheet-add-btn">
                        ...
                        <button type="button"
                            class="w-60 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-12 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 flex items-center gap-3 justify-center">Add
                            Model
