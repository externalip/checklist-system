                ...
                <section id="form-section" class="p-10 mt-5 mb-5 lg:mx-20 bg-gray-100 rounded-lg">
                    ...
                    <div id="question" class="bg-gray-200 mb-3 py-5 px-10 md:px-10 md:py-5 rounded-md md:rounded-md">
                        ...
                        <select id="models" v-model="form.fieldAnswers.ans1"
                            ...
                            <option v-for="model in models" :value="model.model_name" :key="model.id">{{ model.model_name }}
                            </option>
                        </select>
                        ...
                        <ul
                            ...
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                <div class="flex items-center pl-3">
                                    <input v-model="form.fieldAnswers.ans3" id="horizontal-list-radio-startup" type="radio"
                                        value="Start-Up" name="type-of-checking-radio"
