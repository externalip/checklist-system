    ...
    <section id="user-filters" class="mb-5 grid lg:grid-cols-7 sm:grid-cols-2 grid-cols-2 gap-3">
        ...
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                ...
                <!-- dropdown button -->
                <button id="dropdownBgHoverButton" data-dropdown-toggle="dropdownBgHover" class="w-full flex justify-center text-white bg-[--blue] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-20  text-center items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
