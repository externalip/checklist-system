...
<div class="pl-2 mb-2">
    ...
    <section id="user-filters" class="mb-5 grid lg:grid-cols-7 sm:grid-cols-2 grid-cols-2 gap-3">
        ...
        <div>
            ...
            <!-- dropdown button -->
            <button id="dropdownBgHoverButton" data-dropdown-toggle="dropdownBgHover" class="w-full flex justify-center text-white bg-[--blue] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-20  text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Account status
        ...
        <!-- Export button -->
        <div>
            <label for="filter-user-select" class="block mb-2 text-sm font-medium dark:text-white">Export Table</label>
