        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="p-6 md:px-20 relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form @submit.prevent="submit">
                    <div class="mb-2">
                        <label for="role_position" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Role
                            Position</label>
                    ...
                    <div class="mb-2">
                            <label for="add_role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Role Description</label>
                    ...
                    <div class="flex justify-end mt-4">
                        <button type="submit"
                            class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">Add Role</button>
