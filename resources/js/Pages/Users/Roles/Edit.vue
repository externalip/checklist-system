<template>
    <AppLayout title="Update Role">
        <form @submit.prevent="updateRole(role.id)">
            <div
                class="lg:mx-[25%] rounded-lg grid grid-row-3 gap-5 text-[--blue]"
            >
                <!-- Employee Info -->
                <div
                    class="mx-3 border-2 border-gray-300 lg:p-10 p-5 rounded-2xl"
                >
                    <h3
                        class="text-2xl font-semibold mb-2 md:text-left text-center"
                    >
                        Update Role
                    </h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1">
                            ...
                            <div class="col-span-1 p-1">
                                <label for="role_name" class="block mb-1"
                                    >Role Name</label
                                >
                                <input
                                    v-model="form.name"
                            ...
                            <!-- Last Name -->
                            <div class="col-span-1 p-1">
                                <label for="role_description" class="block mb-1"
                        ...
                        <div>
                            <label for="role_access" class="block mb-1"
                                >This role can only access:</label
                            >
                            ...
                            <div>
                                ...
                                ></multiselect>
                                <span
                                    v-if="!selectedPermission.length"
                ...
                <div class="flex justify-center p-10">
                    <button
                        type="submit"
                        class="duration-200 text-white bg-[#3C5393] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                    >
                        Update Role
                    </button>
                    <Link
