...
// Watch for changes in selectedForm.form_name
...
onMounted(() => {
    ...
    console.log('formNameFromQuery:', formNameFromQuery);
});
                ...
                <section id="checklist-dropdown" class="lg:w-6/12 mb-2 rounded-lg">
                    ...
                    <select v-model="selectedForm.form_name" id="pending-checklists"
                        ...
                        <option
                            ...
                            :selected="selectedForm.form_name === form.form_name">{{ form.form_name }}</option>
                    </select>
            ...
            <!-- First Accordion -->
                ...
                <div id="P-Touch Soldering" class="hidden_div accordions">
                    ...
                    <div v-if="counts > 0" v-for="(row, index) in data2" id="accordion-flush" data-accordion="collapse"
                        ...
                        <div :id="'accordion-flush-body-2' + index.toString()" class="hidden border-2 border-gray-100"
                ...
                <div id="P-Touch ICT" class="hidden_div accordions">
                    ...
                    <div v-if="counts > 0" v-for="(row, index) in data3" id="accordion-flush" data-accordion="collapse"
                        ...
                        <div :id="'accordion-flush-body-3' + index.toString()" class="hidden border-2 border-gray-100"
