            ...
            <section id="checksheet-filter-section">
                ...
                <section id="checksheet-filters" class="mb-5 grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-3">
                    ...
                    <div id="checksheet-filter-name-search">
                        ...
                        <form>
                            <label for="filter-user-select" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Search by Checksheet
                                    Name</label>
                            <div class="relative">
                    ...
                    <div id="checksheet-add-btn">
                        ...
                        <button type="button" @click="callCreator" class="w-60 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-12 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 flex items-center gap-3 justify-center">
                                Create Form
                ...
                <section id="checksheet-table-section">
                    ...
                    <div class="relative overflow-x-auto">
                        ...
                        <table class="rounded-lg w-full text-sm text-center text-gray-500 dark:text-gray-400">
                            ...
                            <!-- Table Content -->
                            <tbody>
                                <tr v-for="form in forms" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 transition ease-in-out duration-200">
