...
<template>
    <AppLayout title="Archives">
        <div class="lg:mx-20">
            ...
            <!-- 5S - Checklist -->
            <div
                v-if="selectedOption === '5S Start-Up Check Sheet'"
            ...
            >
                ...
                >
                    <thead
                        style="background-color: #3c5393"
                        class="border-solid border-2 border-black text-xs text-white"
                    >
                        <tr>
                            <th
                                colspan="1"
                                rowspan="2"
                                class="border-solid border-2 border-black px-1 py-1"
                            >
                                Date
                            </th>
                            <th
                    ...
                    <tbody v-for="response_field in response_fields.data">
                        ...
                        >
                            ...
                            <!-- Model Name -->
                            <td
                                class="border-solid whitespace-nowrap border-2 border-black px-1 py-1"
                            >
                                {{
            ...
            <!-- P-Touch Soldering -->
            <div
                v-if="selectedOption === 'P-Touch Soldering'"
            ...
            <!-- P-Touch ICT -->
            <div
                v-if="selectedOption === 'P-Touch ICT'"
                class="relative overflow-x-auto shadow-md sm:rounded-lg"
            >
                <table
                    id="myTable"
