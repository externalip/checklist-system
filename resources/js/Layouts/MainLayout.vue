...
<template>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
            data-drawer-backdrop="false" type="button" @click="() => toggleSidebar()"
          ...
          <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">MA Tech</span>
          </a>
        </div>
  ...
  <aside id="logo-sidebar" :class="[sidebarClass, 'sidebar-transition']"
    class="-translate-x-full fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    aria-label="Sidebar">
  ...
  <div :style="{ marginLeft: isSidebarOpen ? '0' : '16rem' }" class="p-4 sm:ml-64">
    <div class="p-4 mt-14">
      <main>
        <slot />
      </main>
