...
<template>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" data-drawer-backdrop="false"
            @click="() => toggleSidebar()" aria-controls="logo-sidebar" type="button"
          ...
          <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">M.A
              Technology</span>
          </a>
        </div>
  ...
  <aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        <h6 class="text-sm text-center font-bold p-4">Production Checklists</h6>
        <!-- DASHBOARD OPTION -->
        <li>
          <a href="#"
        ...
        <li>
          <a href="#"
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">View Checklists</span>
          </a>
        </li>
        ...
        <h1 class="text-sm text-center font-bold p-4">User Configuration</h1>
        <li>
          <a href=" #"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <svg
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Personnel Management</span>
          </a>
        </li>
        <li>
          <a href=" #"
        ...
        <li>
          <button type="button"
            ...
            </svg><span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">E-commerce</span><svg
  ...
  <!-- CONTENT -->
  <div :style="{ marginLeft: isSidebarOpen ? '16rem' : '0' }" class="p-4 sm:ml-64">
    <div class="p-4 mt-14">
      <main>
        <slot />
      </main>
...
onMounted(() => {
  ...
  const hamburgerButton = document.querySelector('[data-drawer-target="logo-sidebar"]');
  const body = document.body;
  const topNavbar = document.getElementById('top-navbar'); // Get the navbar element
  ...
  // Adjust the top margin of the content based on the navbar height
  const adjustContentMargin = () => {
    const navbarHeight = topNavbar.offsetHeight; // Get the actual height of the navbar
    document.querySelector('.content-wrapper').style.marginTop = `${navbarHeight}px`; // Apply margin
  };
